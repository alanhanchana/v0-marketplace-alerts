        ...
        <div className="container mx-auto max-w-md flex justify-center">
          <div className="flex justify-around w-full py-2">
            ...
            <div className="flex flex-col items-center p-2">
              <div className="h-5 w-5 bg-secondary/50 animate-pulse rounded-full"></div>
              <span className="text-xs mt-1 text-transparent bg-secondary/50 animate-pulse rounded-full">Loading</span>
            </div>
